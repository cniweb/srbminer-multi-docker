...
RUN apt-get update && apt-get -y install wget xz-utils && \
    cd /opt && wget https://github.com/doktor83/SRBMiner-Multi/releases/download/1.1.0/SRBMiner-Multi-1-1-0-Linux.tar.xz && \
	tar xf SRBMiner-Multi-1-1-0-Linux.tar.xz && rm -rf /opt/SRBMiner-Multi-1-1-0-Linux.tar.xz && \
...
WORKDIR "/opt/SRBMiner-Multi-1-1-0"
