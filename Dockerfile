...
RUN apt-get update && apt-get -y install wget xz-utils && \
    cd /opt && wget https://github.com/doktor83/SRBMiner-Multi/releases/download/1.0.8/SRBMiner-Multi-1-0-8-Linux.tar.xz && \
	tar xf SRBMiner-Multi-1-0-8-Linux.tar.xz && rm -rf /opt/SRBMiner-Multi-1-0-8-Linux.tar.xz && \
...
EXPOSE 80
COPY start_zergpool.sh /opt/SRBMiner-Multi-1-0-8/
RUN chmod +x /opt/SRBMiner-Multi-1-0-8/start_zergpool.sh
WORKDIR "/opt/SRBMiner-Multi-1-0-8"
